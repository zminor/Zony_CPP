		...
		while (cur < buf.size() )
		{
			switch (ss->state)
			{
				...
				case ParsingState::COPY_DATA_BLOCK:
				{
					...
					// search for the end of the data block (the possible start of next unit)
